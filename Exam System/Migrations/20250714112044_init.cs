        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StudentAnswers_ChoiceOrTextAnswer", "(ChoiceId IS NOT NULL AND TextAnswer IS NULL) OR (ChoiceId IS NULL AND TextAnswer IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Results_ApplicationUserId_ExamId",
                table: "Results",
                columns: new[] { "ApplicationUserId", "ExamId" },
                unique: true);
